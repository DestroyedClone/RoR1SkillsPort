...
{
    public class HuntressMain : SurvivorMain
    {
        public override string CharacterName => "Huntress";
        ...
        {
            clusterBombDamageCoefficient = config.Bind(ConfigCategory, "Cluster Bomb Damage Coefficient", 3.2f, "").Value;
            clusterBombChildDamageCoefficient = config.Bind(ConfigCategory, "Cluster Bomb Children Damage Coefficient", 3.2f, "").Value;
            clusterBombChildCount = config.Bind(ConfigCategory, "Cluster Bomb Child Bomb Count", 6, "").Value;
        }
        ...
        public override void SetupSpecial()
        {
            ...
            var skillFamily = SurvivorSkillLocator.special.skillFamily;
